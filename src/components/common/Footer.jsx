...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-gray-400 py-8 pb-20 md:pb-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-4 text-sm">{companyInfo.address}</p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              <h4 className="text-sm font-semibold uppercase tracking-wider mb-2 text-yellow-500">
                Контакты
              </h4>
            ...
            <div>
              ...
              <p className="text-sm">{companyInfo.workHours}</p>
            </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {year} A1Detailing. Все права защищены.
          </p>
